...
mod tests {
    ...
    impl BlockExecutorProvider for TestExecutorProvider {
        type Executor<DB: DatabaseRef<Error: Into<ProviderError> + Display> + Send + Sync> = TestExecutor<DB>;
        type BatchExecutor<DB: DatabaseRef<Error: Into<ProviderError> + Display> + Send + Sync> = TestExecutor<DB>;
