...
pub trait BlockExecutorProvider: Send + Sync + Clone + Unpin + 'static {
    ...
    /// the returned state.
    type Executor<DB: DatabaseRef<Error: Into<ProviderError> + Display>>: for<'a> Executor<
        DB,
    ...
    type BatchExecutor<DB: DatabaseRef<Error: Into<ProviderError> + Display>>: for<'a> BatchExecutor<
        DB,
        Input<'a> = BlockExecutionInput<'a, BlockWithSenders>,
...
mod tests {
    ...
    impl BlockExecutorProvider for TestExecutorProvider {
        type Executor<DB: DatabaseRef<Error: Into<ProviderError> + Display>> = TestExecutor<DB>;
        type BatchExecutor<DB: DatabaseRef<Error: Into<ProviderError> + Display>> = TestExecutor<DB>;
